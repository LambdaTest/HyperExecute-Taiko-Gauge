# Run Taiko Gauge Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Taiko Gauge Tests across real browsers and operating systems.
...
```sh
git clone https://github.com/LambdaTest/HyperExecute-Taiko-Gauge.git
cd HyperExecute-Taiko-Gauge
```
...
Download the HyperExecute CLI for your OS and run:
